...
const ReceiptView = props => {
	const {
		...
		transactionDate,
		buyerReceiptModal,
		setBuyerReceiptModalVisibility
	} = props
	return (
				...
				<Grid.Column style={{ maxWidth: '50%' }}>
					<Segment stacked basic>
						...
						<Header
							...
							textAlign="left"
							inverted
							content={`Date of Transaction: ${transactionDate}`}
						/>
						<Divider />
						<Header
							size="medium"
							textAlign="left"
							inverted
							content={`Location: ${receiptLocation}`}
						/>
						<Divider />
						...
						<Header
							...
							textAlign="left"
							inverted
							content={`Total Payment: ₱${totalPrice}`}
						/>
						<Divider />
						<Header inverted size="huge">
						...
						<Button
							...
							as={Link}
							to={'/SearchView'}
							onClick={() => onClickHandler(setBuyerReceiptModalVisibility)}
							inverted
							color="black">
