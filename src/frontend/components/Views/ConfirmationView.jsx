					...
					<Grid textAlign="center" verticalAlign="middle">
						<Grid.Column style={{ maxWidth: '80%' }}>
							<Segment stacked basic>
								...
								<Divider />
								<Dropdown
									style={{ fontSize: 20, background: 'transparent', color: getColor(genderError) }}
									id="gender"
									selection
									fluid
								...
								<Input
									...
									transparent
									inverted
									style={{ color: getColor(emailError) }}
								...
								<Input
									...
									transparent
									inverted
									style={{ color: getColor(addressError) }}
								...
								<Input
									...
									transparent
									inverted
									style={{ color: getColor(creditCardError) }}
								...
								<Input
									...
									iconPosition="left"
									type="date"
									style={{ color: getColor(expirationDateError) }}
									size="massive"
									transparent
									inverted
								...
								/>
								<Divider />
								<Button fluid size="large" onClick={() => confirmationHandler()}>
									Confirm
								</Button>
							</Segment>
						</Grid.Column>
